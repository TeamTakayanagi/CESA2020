...
public class UiFunction : MonoBehaviour
{
    ...
    private ColorBlock m_buttonColor = new ColorBlock();    // カラーブロック  
    private Vector3 m_standardValue = Vector3.zero;         // 基準となる初期座標

    private void Awake()
    {
        // Alpha
        m_buttonColor = gameObject.GetComponent<Button>().colors;   // カラーブロック取得
        ...
        switch (m_alphaChange._alphaType)
        {
            ...
            case AlphaType.Flashing:
                ...
                break;
            case AlphaType.None:
                m_alphaChange._alphaValue = 0.0f;
                break;
            default:
                break;
        }
    ...
    void Update()
    {
        ...
        //m_buttonColor.normalColor = new Color(m_buttonColor.normalColor.r, m_buttonColor.normalColor.g, m_buttonColor.normalColor.b, m_alphaChange._alphaValue);
